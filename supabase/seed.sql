...
-- 4. Clean ALL references to dummy/seed users (including admin-created bookings)
DELETE FROM waitlist WHERE user_id IN ('d1111111-1111-1111-1111-111111111111','d2222222-2222-2222-2222-222222222222','d3333333-3333-3333-3333-333333333333','d4444444-4444-4444-4444-444444444444','d5555555-5555-5555-5555-555555555555','d6666666-6666-6666-6666-666666666666','d0000000-0000-0000-0000-000000000001');
DELETE FROM bookings WHERE user_id IN ('d1111111-1111-1111-1111-111111111111','d2222222-2222-2222-2222-222222222222','d3333333-3333-3333-3333-333333333333','d4444444-4444-4444-4444-444444444444','d5555555-5555-5555-5555-555555555555','d6666666-6666-6666-6666-666666666666','d0000000-0000-0000-0000-000000000001');
DELETE FROM user_credits WHERE user_id IN ('d1111111-1111-1111-1111-111111111111','d2222222-2222-2222-2222-222222222222','d3333333-3333-3333-3333-333333333333','d4444444-4444-4444-4444-444444444444','d5555555-5555-5555-5555-555555555555','d6666666-6666-6666-6666-666666666666','d0000000-0000-0000-0000-000000000001');
...
-- 5. Delete the seed users themselves
DELETE FROM users WHERE id IN ('d1111111-1111-1111-1111-111111111111','d2222222-2222-2222-2222-222222222222','d3333333-3333-3333-3333-333333333333','d4444444-4444-4444-4444-444444444444','d5555555-5555-5555-5555-555555555555','d6666666-6666-6666-6666-666666666666','d0000000-0000-0000-0000-000000000001');
